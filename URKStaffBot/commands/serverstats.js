...
exports.runcmd = (fivemexports, client, message, params) => {
    ...
    let totalBank = 0
    let totalChips = 0
    fivemexports.ghmattimysql.execute("SELECT * FROM `urk_user_vehicles`", [], (cars) => {
        fivemexports.ghmattimysql.execute("SELECT * FROM `urk_user_vehicles` WHERE locked = 1", [], (lockedcars) => {
            fivemexports.ghmattimysql.execute("SELECT * FROM `urk_user_data`", [], (userdata) => {
                fivemexports.ghmattimysql.execute("SELECT * FROM urk_warnings", [], (warnings) => {
                    fivemexports.ghmattimysql.execute("SELECT * FROM urk_user_moneys", [], (money) => {
                        fivemexports.ghmattimysql.execute("SELECT * FROM urk_casino_chips", [], (chips) => {
                            fivemexports.ghmattimysql.execute("SELECT * FROM `urk_users`", [], (users) => {
