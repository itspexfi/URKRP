var config = {
  ...
  'discord': {
    'show': true,
    'discordLink': 'https://discord.gg/urkfivem',
  },
...
var gettingstarted = [
  'Welcome to URK',
  'The world of URK is pretty huge so it can be a little overwhelming at first! Here\'s a couple things you can do to get started and work you way up in the world:',
  '',
...
var generalhotkeys = [
  ...
  'Press <kbd>F5</kbd> to open the URK Gang Menu',
...
var rphotkeys = [
  'Use <code>/k</code> to get on your knees',
