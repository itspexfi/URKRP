    ...
    var e = {
            ...
            118: (e, t, n) => {
                ...
                n.r(t), n.d(t, {
                    ...
                    if (t >= 0) {
                        ...
                        n.items ? e.showNestedMenu(n) : e.onClick && (e.onClick(n), e.closeOnClick && (e.close(), fetch("http://urk/disablenuifocus", {
                            method: "POST",
                            body: JSON.stringify({
                                nuifocus: !1
                            })
                    ...
                    var e = this;
                    e.parentItems.length > 0 ? e.returnToParentMenu() : (e.close(), fetch("http://urk/disablenuifocus", {
                        method: "POST",
                        body: JSON.stringify({
                            nuifocus: !1
                        })
            ...
            22: (e, t, n) => {
                ...
                class o extends a.Component {
                    ...
                    countdownEnded() {
                        fetch("https://urk-ui1/countdownEnded", {
                            method: "POST",
                            body: ""
                        ...
                        if (1 == e.data.openMenu)
                            if ("ped" == e.data.type) {
                                ...
                                t = 1 == e.data.police ? new o.default({
                                    ...
                                    menuItems: u,
                                    onClick: function(t) {
                                        fetch("http://urk-ui1/radialClick", {
                                            method: "POST",
                                            body: JSON.stringify({
                                                itemid: t.id,
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    switch (n.type) {
                        ...
                        case "RESPAWN_BUTTON_CLICK":
                            return fetch("https://urk-ui1/respawnButtonClicked", {
                                method: "POST",
                                body: JSON.stringify({
