globalBlips = {}
function tURK.addBlip(a, b, c, d, e, f, g, h)
...
function tURK.removeBlip(j)
    RemoveBlip(j)
end
function tURK.removeBlipAtCoords(x,y,z) -- used to remove green house blips for everyone when purchased
...
local k = {}
function tURK.setNamedBlip(l, a, b, c, d, e, f, g)
    tURK.removeNamedBlip(l)
    k[l] = tURK.addBlip(a, b, c, d, e, f, g)
    return k[l]
end
function tURK.removeNamedBlip(l)
    if k[l] ~= nil then
        tURK.removeBlip(k[l])
        k[l] = nil
    end
end
function tURK.setGPS(a, b)
    SetNewWaypoint(a + 0.0001, b + 0.0001)
end
function tURK.setBlipRoute(j)
    SetBlipRoute(j, true)
end
local m = {}
...
local p = {}
local q = {}
function tURK.addMarker(a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    local I = {
...
function tURK.setNamedMarker(l, a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    tURK.removeNamedMarker(l)
    o[l] = tURK.addMarker(a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    return o[l]
end
function tURK.removeNamedMarker(l)
    if o[l] ~= nil then
        tURK.removeMarker(o[l])
        o[l] = nil
    end
end
local J = {}
...
Citizen.CreateThread(
    function()
        while true do
            q = tURK.getNearbyMarkers()
            Citizen.Wait(10000)
        end
    end
)
function tURK.getNearbyMarkers()
    local N = {}
    local O = tURK.getPlayerCoords()
    local P = 0
...
function tURK.setArea(l, a, b, c, T, U)
...
RegisterCommand("nextblip",function()
    ...
    a4 = tURK.addBlip(1103.9739990234, 211.95138549805, -49.440101623535, a5, 0, "Chips Cashier", 0.8, true)
end)
