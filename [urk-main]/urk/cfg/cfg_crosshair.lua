...
function loadCrosshairKvp()
    populateArrays()
    local isEnabled = GetResourceKvpInt("urk_crosshair_enabled")
    if isEnabled == 0 then
    ...
    local useCenterDot = GetResourceKvpInt("urk_crosshair_center_dot_enabled")
    ...
    local crosshairVisibility = GetResourceKvpInt("urk_crosshair_visibility")
    ...
    local crosshairLength = GetResourceKvpInt("urk_crosshair_length")
    ...
    local crosshairThickness = GetResourceKvpInt("urk_crosshair_thickness")
    ...
    local crosshairGap = GetResourceKvpInt("urk_crosshair_gap")
    ...
    local red = GetResourceKvpInt("urk_crosshair_red")
    if red == 0 then
    ...
    local green = GetResourceKvpInt("urk_crosshair_green")
    if green == 0 then
    ...
    local blue = GetResourceKvpInt("urk_crosshair_blue")
    if blue == 0 then
...
function saveCrosshair()
    SetResourceKvpInt('urk_crosshair_enabled', cfg.options.enabled)
    SetResourceKvpInt('urk_crosshair_center_dot_enabled', cfg.options.centerDotEnabled)
    SetResourceKvpInt('urk_crosshair_visibility', cfg.options.visibility)
    SetResourceKvpInt('urk_crosshair_length', cfg.options.length.index)
    SetResourceKvpInt('urk_crosshair_thickness', cfg.options.thickness.index)
    SetResourceKvpInt('urk_crosshair_gap', cfg.options.gap.index)
    SetResourceKvpInt('urk_crosshair_red', cfg.options.colour.red)
    SetResourceKvpInt('urk_crosshair_blue', cfg.options.colour.blue)
    SetResourceKvpInt('urk_crosshair_green', cfg.options.colour.green)
end
