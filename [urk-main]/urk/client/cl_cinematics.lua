RMenu.Add("mainmenu","cinematic",RageUI.CreateMenu("", "", tURK.getRageUIMenuWidth(), tURK.getRageUIMenuHeight(), "new_editor", "r_editor_header"))
RMenu:Get("mainmenu", "cinematic"):SetSubtitle("~r~URK Cinematic Editor")
RMenu.Add("load_scene","cinematic",RageUI.CreateSubMenu(RMenu:Get("mainmenu", "cinematic"),"","",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("load_scene", "cinematic"):SetSubtitle("~r~Load Scene")
RMenu.Add("scene_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("load_scene", "cinematic"),"","",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("scene_manager", "cinematic"):SetSubtitle("~r~Scene Manager")
RMenu.Add("camera_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("scene_manager", "cinematic"),"","",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("camera_manager", "cinematic"):SetSubtitle("~r~Camera Manager")
RMenu.Add("screeneffect_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("screeneffect_manager", "cinematic"):SetSubtitle("~r~Screen Effect Manager")
RMenu.Add("timecycle_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("timecycle_manager", "cinematic"):SetSubtitle("~r~Timecycle Effect Manager")
RMenu.Add("shake_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("shake_manager", "cinematic"):SetSubtitle("~r~Shake Effect Manager")
RMenu.Add("add_camera","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("add_camera", "cinematic"):SetSubtitle("~r~Add Camera")
RMenu.Add("camera_focus_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("camera_focus_manager", "cinematic"):SetSubtitle("~r~Camera Focus")
RMenu.Add("weather_time_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("mainmenu", "cinematic"),"","",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("weather_time_manager", "cinematic"):SetSubtitle("~r~Time/Weather Manager")
RMenu.Add("dof_manager","cinematic",RageUI.CreateSubMenu(RMenu:Get("camera_manager", "cinematic"),"","",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"new_editor","r_editor_header"))
RMenu:Get("dof_manager", "cinematic"):SetSubtitle("~r~Depth of Field Manager")
...
Citizen.CreateThread(function()
    m = json.decode(GetResourceKvpString("urk_scenedata") or "{}")
end)
RegisterNetEvent("URK:openCinematicMenu",function()
    a(true)
end)
function tURK.createCinematicScene(P)
    m[P] = {}
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Scene created & saved.")
end
function tURK.deleteCinematicScene(P)
    m[P] = nil
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Scene deleted & saved.")
end
function tURK.createCamera(P, Q)
    if #m[P] == 0 then
        Q.transition = 100
    end
    table.insert(m[P], Q)
    ...
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Camera created & saved.")
end
function tURK.modifyCamera(P, Q, R)
    m[P][R] = Q
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Camera modified & saved.")
end
function tURK.deleteCamera(P, S)
    table.remove(m[P], S)
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Camera deleted & saved.")
end
function tURK.modifyTransition(n, q, T)
    m[n][q].transition = tonumber(T)
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Transition change saved.")
end
function tURK.modifyCameraBlending(n, q, U)
    m[n][q].blending = l[U]
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Camera Blending change saved.")
end
function tURK.modifyScreeneffect(n, q, V)
    m[n][q].screeneffect = V
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Screeneffect change saved.")
end
function tURK.modifyTimecycleEffect(n, q, W)
    m[n][q].timecycleEffect = W
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Timecycle Effect change saved.")
end
function tURK.setTimecycleIntensity(n, q, f)
    m[n][q].timecycleIntensity = f
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Timecycle intensity change saved.")
end
function tURK.modifyShakeEffect(n, q, X)
    m[n][q].shake = X
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Shake change saved.")
end
function tURK.modifyCameraType(n, q, type)
    m[n][q].type = type
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Camera type change saved.")
end
function tURK.addCameraFocus(n, q, Y, Z)
    m[n][q].focusType = Y
    m[n][q].focusData = Z
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~Follow player change saved.")
end
function tURK.setCameraFov(n, q)
    m[n][q].fov = i[A]
    SetResourceKvp("urk_scenedata", json.encode(m))
    tURK.notify("~g~FOV change saved.")
end
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('camera_manager', 'cinematic')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            if q and m[n][q] then
                RMenu:Get("camera_manager", "cinematic"):SetSubtitle("~r~" .. m[n][q].type)
                RageUI.ButtonWithStyle("~r~Transition: " .. m[n][q].transition .. "ms","",{RightLabel = "→→→"},true,function(a1, a2, a3)
                    if a3 then
                        local T = getSearchField("Transition(in ms):")
                        if tonumber(T) then
                            tURK.modifyTransition(n, q, T)
                        else
                            tURK.notify("~r~Failed to change transition time.")
                        end
                    end
                end,RMenu:Get("camera_manager", "cinematic"))
                ...
                RageUI.List("Camera Type:",j,w,"",{},true,function(a1, a2, a3, a8)
                    if a8 ~= w then
                        w = a8
                        tURK.modifyCameraType(n, q, j[w])
                    end
                end,function()end,nil)
                RageUI.List("Camera Blending:",k,x,"",{},true,function(a1, a2, a3, a8)
                    if a8 ~= x then
                        x = a8
                        tURK.modifyCameraBlending(n, q, k[x])
                    end
                end,function()end,nil)
                ...
                RageUI.List("Timecycle Intensity",f,e,"",{},true,function(a1, a2, a3, a8)
                    ...
                    if a8 ~= e then
                        ...
                        if m[n][q].timecycleEffect ~= "" then
                            ...
                            tURK.setTimecycleIntensity(n, q, f[e])
                        end
                    end
                end,function()end,nil)
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            for g = 1, #c do
                RageUI.ButtonWithStyle(c[g],"",{RightLabel = "→→→"},true,function(a1, a2, a3)
                    ...
                    if a3 then
                        tURK.modifyScreeneffect(n, q, c[g])
                    end
                end,RMenu:Get("camera_manager", "cinematic"))
            end
        end)
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            for g = 1, #d do
                RageUI.ButtonWithStyle(d[g],"",{RightLabel = "→→→"},true,function(a1, a2, a3)
                    ...
                    if a3 then
                        tURK.modifyTimecycleEffect(n, q, d[g])
                    end
                end,RMenu:Get("camera_manager", "cinematic"))
            end
        end)
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            for g = 1, #h do
                RageUI.ButtonWithStyle(h[g],"",{RightLabel = "→→→"},true,function(a1, a2, a3)
                    ...
                    if a3 then
                        tURK.modifyShakeEffect(n, q, h[g])
                    end
                end,RMenu:Get("camera_manager", "cinematic"))
            end
        end)
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = false}, function()
            ...
            RageUI.ButtonWithStyle("Player","",{RightLabel = "→→→"},true,function(a1, a2, a3)
                if a3 then
                    ...
                    if a9 ~= "" then
                        tURK.addCameraFocus(n, q, "player", a9)
                    end
                end
            end,RMenu:Get("camera_manager", "cinematic"))
            RageUI.ButtonWithStyle("Coordinates","",{RightLabel = "→→→"},true,function(a1, a2, a3)
                if a3 then
                    tURK.clientPrompt("Enter coordinates:","",function(aa)
                        local ab = {}
                        ...
                        tURK.addCameraFocus(n, q, "coord", vector3(ad, ae, af))
                    end)
                end
            end,RMenu:Get("camera_manager", "cinematic"))
        end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if (o or p) and noclipActive and tURK.getPlayerVehicle() ~= 0 then
            tURK.notify("~r~You may not noclip when in a vehicle.")
            tURK.toggleNoclip()
        end
            ...
            if a0.focusType ~= "" then
                if a0.focusType == "player" then
                    ...
                    if aj then
                        ...
                        print("[URK Cinematic] Failed to point cam at player, could not get entity.")
                    end
...
Citizen.CreateThread(function()
    while true do
        local al, am = tURK.getPlayerVehicle()
        ...
        if an ~= 0 and IsEntityAPed(an) and IsPedAPlayer(an) and not IsEntityVisible(an) then
            ...
            if ao ~= -1 then
                ...
                if ap > 0 then
                    if not tURK.clientGetPlayerIsStaff(tURK.clientGetUserIdFromSource(ap)) then
