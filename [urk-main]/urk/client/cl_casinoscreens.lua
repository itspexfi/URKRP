...
local c = "https://www.youtube.com/embed/lX_IN4v-RnA?version=3&fs=1&autoplay=1&loop=1&playlist=GKbpbbLrya0"
...
function jimmy()
  ...
  --  print("jimmy tv lego!")
    ...
    while true do
        if #(tURK.getPlayerCoords() - s) < 4.0 then
...
AddEventHandler("URK:enteredDiamondCasino",function()
    insideDiamondCasino = true
    startCasinoThreads()
end)

AddEventHandler("URK:exitedDiamondCasino",function()
