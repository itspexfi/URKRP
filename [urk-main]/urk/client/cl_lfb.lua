...
-- local a = false
-- RMenu.Add("lfb","main",RageUI.CreateMenu("","Status: ~g~Available",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight(),"banners", "lfb"))
-- RMenu.Add("lfb","tools",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Tools",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight()))
-- RMenu.Add("lfb","water",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~Water",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight()))
-- RMenu.Add("lfb","ba",RageUI.CreateSubMenu(RMenu:Get("lfb", "main"),"","LFB: ~b~BA",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight()))
-- RMenu.Add("lfb","firemain",RageUI.CreateMenu("", "Manage Fires", tURK.getRageUIMenuWidth(), tURK.getRageUIMenuHeight(), "banners", "lfb"))
-- RMenu.Add("lfb","fire",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Start Fires",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight()))
-- RMenu.Add("lfb","management",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Manage Fires",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight()))
-- RMenu.Add("lfb","settings",RageUI.CreateSubMenu(RMenu:Get("lfb", "firemain"),"","LFB: ~b~Settings",tURK.getRageUIMenuWidth(),tURK.getRageUIMenuHeight()))
...
--                     function(b, c, d)
--                         if d then
--                             tURK.loadCustomisationPreset("NoBreathingApperatus")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tURK.loadCustomisationPreset("BreathingApperatusDown")
--                         end
--                     end
--                 )
--                 RageUI.Button(
...
--                     function(b, c, d)
--                         if d then
--                             tURK.loadCustomisationPreset("BreathingApperatusUp")
--                         end
--                     end
--                 )
--             end,
...
--                     function(b, c, d)
--                         if d then
--                             TriggerServerEvent("URK:updateFireOptions", l, n, m)
--                         end
--                     end
--                 )
--             end,
...
--                     function(b, c, d)
--                         if d then
--                             TriggerServerEvent("URK:stopAllFires")
--                         end
--                     end
--                 )
--             end,
...
--                             TriggerServerEvent("URK:updateFireTableServer", s, u, false, false, true)
--                         end
--                     end
--                 )
--             end,
...
--     end
-- )
-- TriggerServerEvent("URK:receiveLFBTablesServer")
-- local v = {}
-- local w = {}
-- local x = {}
-- local y = {}
...
--     return tURK.generateUUID("fire", 20, "alphanumeric")
-- end
-- RegisterNetEvent("URK:startFireMenu",function(F, G, H)
--     RageUI.ActuallyCloseAll()
--     RageUI.Visible(RMenu:Get("lfb", "tools"), false)
--     RageUI.Visible(RMenu:Get("lfb", "main"), false)
--     RageUI.Visible(RMenu:Get("lfb", "water"), false)
...
-- RegisterNetEvent("URK:receiveLFBTables",function(I, J, K, L, M, N, O, P, Q)
--     v = I
--     w = J
--     x = K
--     y = L
...
-- RegisterNetEvent("URK:updateFireTable",function(R, S, T, U)
--     if T then
...
--         tURK.loadPtfx(E[f[v[R].type].smokeType].dict)
...
-- }
-- RegisterNetEvent("URK:updateSupplyLineTable",function(R, S, T)
--     if T then
--         w[R] = nil
--         return
--     end
...
--     local a4 = tURK.getPlayerPed()
--     local ae = tURK.getPlayerVehicle()
--     if ae ~= 0 then
--         tURK.notify("~r~Error~w~: You must not be inside a vehicle")
--         return
--     end
...
--         if ad then
--             if ag then
--                 tURK.notify("~r~Error~w~: A supply line is already setup on this vehicle")
--             else
...
--                         Wait(0)
--                     end
--                     TriggerServerEvent("URK:createLFBPropLog", "Supply Line", GetEntityCoords(aj, true))
...
--                     w[af] = {af, al, t}
--                     TriggerServerEvent("URK:updateSupplyLineTable", af, w[af], false)
--                     SetModelAsNoLongerNeeded(a2)
--                     tURK.notify("~g~Success~w~: Supply line setup")
--                 else
--                     tURK.notify("~r~Error~w~: You cannot setup a supply line on this vehicle")
--                 end
--             end
--         else
--             if ag then
--                 TriggerServerEvent("URK:updateSupplyLineTable", af, w[af], true)
--                 TriggerServerEvent("URK:lfbDeleteSupplyLine", w[af][2])
--                 TriggerServerEvent("URK:removeVehicleStablisers", af)
--                 w[af] = nil
--                 tURK.notify("~g~Success~w~: Supply line removed")
--             else
--                 tURK.notify("~g~Success~w~: No supply line found")
--             end
--         end
--     else
--         tURK.notify("~r~Error~w~: No vehicle found")
--     end
-- end
-- local am = 200
-- local an = {}
...
-- local ap = false
-- RegisterNetEvent("URK:hoseUpdate",function(aq, ar, T)
--     if T then
--         if an[aq] ~= nil then
--             an[aq][3] = false
--             if an[aq][4] ~= nil then
...
--                 if as == GetHashKey(ao) and IsPlayerFreeAiming(tURK.getPlayerId()) then
--                     a0 = true
...
--                             handleHose()
--                         else
--                             tURK.notify("~r~Notice~w~: You have no active supply of water")
--                         end
--                     end
--                 end
--             end
...
--             if i[3] then
--                 local ar = DecorGetFloat(tURK.getObjectId(i[1]), "HosePitch")
--                 if i[4] ~= nil then
...
--     local at = tURK.getObjectId(an[aq][1], "hoseParticle")
--     local t = GetEntityCoords(at)
--     if #(tURK.getPlayerCoords() - t) < 100.0 and GetSelectedPedWeapon(at) == GetHashKey(ao) then
--         tURK.loadPtfx("core")
...
-- function handleHose()
--     local a4 = tURK.getPlayerPed()
--     local aq = tURK.getNetId(a4, "handleHose()")
--     TriggerServerEvent("URK:hoseUpdateServer", aq, 0.0, false)
--     ap = true
--     while ap do
--         DisableControlAction(0, 24, true)
...
--         putOutFires()
--         if not IsDisabledControlPressed(0, 24) or tURK.getPlayerVehicle() ~= 0 or IsPauseMenuActive() or GetSelectedPedWeapon(a4) ~= GetHashKey(ao) or not IsPlayerFreeAiming(tURK.getPlayerId()) or not X and _ < 1 then
--             ap = false
--             TriggerServerEvent("URK:hoseUpdateServer", aq, 0.0, true)
--         end
--         Wait(0)
--     end
-- end
...
--             local a6 = GetOffsetFromEntityInWorldCoords(tURK.getPlayerPed(), 0.0, 3.0, 0.5)
--             if #(a6 - i.coords) < 7.0 then
--                 local av = math.random(1, f[i.type].chance)
--                 if av == 1 then
--                     local H = i.size * 0.92
--                     if H < 0.5 then
--                         TriggerServerEvent("URK:updateFireTableServer", h, v[h], true, false)
--                         Wait(5000)
--                     else
--                         v[h].size = H
--                         TriggerServerEvent("URK:updateFireTableServer", h, v[h], false, true)
--                         Wait(5000)
--                     end
--                     break
--                 end
...
--     end
-- end
-- RegisterNetEvent("URK:updateMonitorsTable",function(R, S, T)
--     if T then
--         x[R] = nil
--         return
--     end
...
-- RegisterNetEvent("URK:toggleWaterClient",function(R)
--     if x[R] ~= nil then
--         x[R][4] = not x[R][4]
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("URK:createLFBPropLog", "Water Monitor", GetEntityCoords(aj, true))
...
--         TriggerServerEvent("URK:updateMonitorsTable", al, x[al], false)
--         SetModelAsNoLongerNeeded(ax)
--         tURK.notify("~g~Success~w~: Water monitor setup")
--     else
--         local ai = false
--         local ay = 0
--         for h, i in pairs(x) do
...
--         if ai then
--             if x[ay][4] then
--                 tURK.notify("~r~Error~w~: This monitor is active and cannot be removed")
--             else
--                 local aj = tURK.getObjectId(x[ay][1], "handleWaterMonitor")
--                 TriggerServerEvent("URK:updateMonitorsTable", ay, x[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 x[ay] = nil
--                 tURK.notify("~g~Success~w~: Water monitor removed")
--             end
--         else
--             tURK.notify("~r~Error~w~: No water monitor found")
--         end
--     end
-- end
-- RegisterNetEvent("URK:adjustPitchClient",function(R, az)
--     if aw[R] ~= nil and aw[R].handle ~= nil and DoesParticleFxLoopedExist(aw[R].handle) then
--         local t = x[R][2]
--         StopParticleFxLooped(aw[R].handle, false)
--         StopParticleFxLooped(aw[R].handle2, false)
...
--                                 end
--                                 if az ~= 0.0 then
--                                     TriggerServerEvent("URK:adjustPitchServer", h, az)
--                                     Wait(1000)
--                                 end
--                                 DisableControlAction(0, 38, true)
--                                 if IsDisabledControlPressed(0, 38) then
--                                     pressed = true
--                                     TriggerServerEvent("URK:toggleWaterServer", h)
--                                     tURK.notify("~g~Success~w~: Water monitor toggled")
--                                     Wait(aC * 1000)
--                                 end
--                             else
...
--                                     end
--                                 else
--                                     tURK.notify("~r~Error~w~: No active supply line found to enable this water monitor")
--                                 end
--                             end
--                         else
--                             if supplyLineNearby(t) then
...
--                                     X = true
--                                     Y = h
--                                     tURK.notify("~g~Success~w~: You are now connected to this vehicle")
--                                     aF = true
--                                     _ = am
--                                     break
--                                 end
...
--                                             Z[af] = nil
--                                         end)
--                                         tURK.notify("~g~Success~w~: You now have a limited supply of water from the nearest vehicle")
--                                     end
--                                 else
--                                     if _ < 1 then
--                                         tURK.notify("~r~Notice~w~: This vehicle has already supplied you with water, setup a supply line for more")
--                                         Wait(5000)
--                                     end
--                                 end
--                             end
...
--                 if Y ~= 0 then
--                     if w[Y] == nil then
--                         tURK.notify("~r~Notice~w~: You have now been disconnected from the supply line")
--                         X = false
--                     end
--                 end
--                 if X then
...
--     if a0 then
--         drawNativeText("~r~Supply Line~w~: " .. tostring(aE) .. "/100 %")
--     end
-- end
-- tURK.createThreadOnTick(func_displayHoseLeft)
-- local aI = {}
-- local aJ = 2.0
-- RegisterNetEvent("URK:toggleWaterTents",function(R)
--     if y[R] ~= nil then
--         y[R][8] = not y[R][8]
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("URK:createLFBPropLog", "Decontamination Tent", GetEntityCoords(aj, true))
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
--         SetEntityHeading(aj, GetEntityHeading(a4))
...
--         TriggerServerEvent("URK:updateTentsTable", al, y[al], false)
--         SetModelAsNoLongerNeeded(aK)
--         tURK.notify("~g~Success~w~: Decontamination tent setup")
--     else
--         local ai = false
--         local ay = 0
...
--         if ai then
--             if y[ay][8] then
--                 tURK.notify("~r~Error~w~: This decontamination tent is active and cannot be removed")
--             else
--                 local aj = tURK.getObjectId(y[ay][1], "handleDecontaminationTent")
--                 TriggerServerEvent("URK:updateTentsTable", ay, y[ay], true)
--                 if DoesEntityExist(aj) then
--                     DeleteEntity(aj)
--                 end
--                 y[ay] = nil
--                 tURK.notify("~g~Success~w~: Decontamination tent removed")
--             end
--         else
--             tURK.notify("~r~Error~w~: No decontamination tent found")
--         end
--     end
-- end
-- RegisterNetEvent("URK:updateTentsTable",function(R, S, T)
--     if T then
--         y[R] = nil
--         return
--     end
...
--                     DisableControlAction(0, 38, true)
--                     if IsDisabledControlPressed(0, 38) then
--                         TriggerServerEvent("URK:toggleWaterTents", h)
--                         tURK.notify("~g~Success~w~: Decontamination showers toggled")
--                     end
--                 end
--             end
--         end
...
-- RegisterNetEvent("URK:updateCushionsTable",function(R, S, T)
--     if T then
--         z[R] = nil
--         return
--     end
...
--             Wait(0)
--         end
--         TriggerServerEvent("URK:createLFBPropLog", "Rescue Cushion", GetEntityCoords(aj, true))
--         SetEntityCollision(aj, false, true)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
...
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         z[al] = {al, a6}
--         TriggerServerEvent("URK:updateCushionsTable", al, z[al], false)
--         SetModelAsNoLongerNeeded(aR)
--         tURK.notify("~g~Success~w~: Rescue cushion setup")
--     else
--         local ai = false
--         local ay = 0
...
--         end
--         if ai then
--             TriggerServerEvent("URK:deleteProp", z[ay][1])
--             local aj = tURK.getObjectId(z[ay][1], "handleRescueCushion")
--             TriggerServerEvent("URK:updateCushionsTable", ay, z[ay], true)
--             if DoesEntityExist(aj) then
--                 DeleteEntity(aj)
--             end
--             z[ay] = nil
--             tURK.notify("~g~Success~w~: Rescue cushion removed")
--         else
--             tURK.notify("~r~Error~w~: No rescue cushion found")
--         end
--     end
-- end
-- local aS = false
...
--                                 SetPlayerFallDistance(tURK.getPlayerId(), 250.0)
--                                 heightSet = true
--                             else
--                                 SetPlayerFallDistance(tURK.getPlayerId(), 5.0)
--                             end
--                         else
--                             SetPlayerFallDistance(tURK.getPlayerId(), 5.0)
--                         end
...
--                                 local V = #(tURK.getPlayerCoords() - i[2])
--                                 if V < 4.0 then
...
-- end
-- )
-- RegisterNetEvent("URK:updateStabilisersTable",function(R, S, T)
--     if T then
--         A[R] = nil
--         return
--     end
--     A[R] = S
-- end)
-- RegisterNetEvent("URK:updateFansTable",function(R, S, T)
--     if T then
--         B[R] = nil
--         return
--     end
--     B[R] = S
-- end)
-- RegisterNetEvent("URK:stopRtcParticles",function(t)
--     Wait(20 * 1000)
-- end)
...
--     if not a then
--         tURK.loadModel(aV)
--         tURK.loadAnimDict("weapons@heavy@minigun")
...
--             TriggerServerEvent("URK:deleteProp", NetworkGetNetworkIdFromEntity(aW))
--             DetachEntity(a4)
--             DetachEntity(aW)
--             DeleteEntity(aW)
--             ClearPedTasks(a4)
...
--                             TriggerServerEvent("URK:rtcOpenDoor", ba, ak[b7][2], tURK.getPlayerCoords(), true)
--                             aD = true
--                         end
--                         if IsDisabledControlJustPressed(0, 191) then
--                             local ba = NetworkGetNetworkIdFromEntity(ae)
--                             TriggerServerEvent("URK:rtcOpenDoor", ba, ak[b7][2], tURK.getPlayerCoords(), false)
--                             aD = true
--                         end
--                         Wait(0)
--                     end
...
--     )
-- end
-- RegisterNetEvent("URK:rtcOpenDoor",function(ba, ak, t, bb)
--     local ae = tURK.getObjectId(ba, "URK:rtcOpenDoor")
...
--     end
-- end)
-- RegisterNetEvent("URK:spreadersSound",function(t)
--     local bc = tURK.getPlayerCoords()
--     local V = #(t - bc)
--     if V < 15.0 then
...
--         if ad then
--             if ag then
--                 tURK.notify("~r~Error~w~: Stabilisers are already setup on this vehicle")
--             else
--                 FreezeEntityPosition(ae, true)
--                 tURK.loadModel(bd)
--                 local t = GetEntityCoords(ae)
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("URK:createLFBPropLog", "Vehicle Stablisers", GetEntityCoords(aj, true))
--                 SetEntityCollision(aj, false, true)
...
--                 A[af] = {af, al, bl}
--                 TriggerServerEvent("URK:updateStabilisersTable", af, A[af], false)
--                 SetModelAsNoLongerNeeded(bd)
--                 tURK.notify("~g~Success~w~: Stabilisers setup")
--             end
--         else
--             if ag then
--                 local aj = tURK.getObjectId(A[af][2], "handleStabilisers 1")
--                 local bg = tURK.getObjectId(A[af][3], "handleStabilisers 2")
--                 TriggerServerEvent("URK:updateStabilisersTable", af, A[af], true)
--                 if DoesEntityExist(aj) then
--                     TriggerServerEvent("URK:deleteProp", NetworkGetNetworkIdFromEntity(aj))
--                     DeleteEntity(aj)
--                 end
--                 if DoesEntityExist(bg) then
--                     TriggerServerEvent("URK:deleteProp", NetworkGetNetworkIdFromEntity(bg))
--                     DeleteEntity(bg)
--                 end
--                 TriggerServerEvent("URK:removeVehicleStablisers", af)
--                 A[af] = nil
--                 tURK.notify("~g~Success~w~: Stabilisers removed")
--             else
--                 tURK.notify("~r~Error~w~: No stabilisers found")
--             end
--         end
--     else
--         tURK.notify("~r~Error~w~: No vehicle found")
--     end
-- end
-- RegisterNetEvent("URK:removeVehicleStablisers",function(bm)
...
--             Wait(0)
--         end
--         TriggerServerEvent("URK:createLFBPropLog", "Extractor Fan", GetEntityCoords(aj, true))
--         SetEntityCollision(aj, false, true)
--         local al = NetworkGetNetworkIdFromEntity(aj)
--         PlaceObjectOnGroundProperly(aj)
--         FreezeEntityPosition(aj, true)
--         B[al] = {al, a6}
--         TriggerServerEvent("URK:updateFansTable", al, B[al], false)
--         SetModelAsNoLongerNeeded(bn)
--         tURK.notify("~g~Success~w~: Fan setup")
--         TriggerServerEvent("URK:stopRtcParticles", t)
--     else
--         local ai = false
--         local ay = 0
...
--         end
--         if ai then
--             local aj = tURK.getObjectId(B[ay][1], "handleFan")
--             TriggerServerEvent("URK:updateFansTable", ay, B[ay], true)
--             if DoesEntityExist(aj) then
--                 TriggerServerEvent("URK:deleteProp", NetworkGetNetworkIdFromEntity(aj))
--                 DeleteEntity(aj)
--             end
--             B[ay] = nil
--             tURK.notify("~g~Success~w~: Fan removed")
--         else
--             tURK.notify("~r~Error~w~: No fan found")
--         end
--     end
-- end
-- local bo = false
...
--     end
-- end)
-- RegisterNetEvent("URK:updateJackTable",function(R, S, T)
--     if T then
--         C[R] = nil
--         return
--     end
--     C[R] = S
-- end)
-- RegisterNetEvent("URK:updateChockTable",function(R, S, T)
--     if T then
--         D[R] = nil
--         return
--     end
--     D[R] = S
-- end)
-- RegisterNetEvent("URK:toggleChockWheels",function(af)
--     local ae = tURK.getObjectId(af, "URK:toggleChockWheels")
--     if DoesEntityExist(ae) then
...
--             tURK.notify("~r~Error~w~: You are currently using a jack. Press ENTER to stop.")
--             return
--         end
--         if ad then
--             if ag then
--                 if not br then
--                     C[af][5] = true
--                     TriggerServerEvent("URK:updateJackTable", af, C[af], false)
--                     local bs = tURK.getObjectId(C[af][2], "handleJack 1")
--                     local bt = tURK.getObjectId(C[af][3], "handleJack 2")
--                     TriggerServerEvent("URK:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                     tURK.notify("~g~Success~w~: You're now controlling the inflatable jack")
--                     handleLifting(ae, af, bs)
--                 else
--                     tURK.notify("~r~Error~w~: This inflatable jack is in use")
--                 end
--             else
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("URK:createLFBPropLog", "Inflatable Jack", GetEntityCoords(bs, true))
...
--                 tURK.notify("~g~Success~w~: Inflatable jack setup")
--                 handleLifting(ae, af, bs)
--             end
--         else
--             if ag then
...
--                     tURK.notify("~r~Error~w~: This inflatable jack is in use")
--                 else
--                     local bs = tURK.getObjectId(C[af][2], "handleJack 3")
--                     local bt = tURK.getObjectId(C[af][3], "handleJack 4")
--                     TriggerServerEvent("URK:updateJackTable", af, C[af], true)
--                     if DoesEntityExist(bs) then
--                         TriggerServerEvent("URK:deleteProp", NetworkGetNetworkIdFromEntity(bs))
--                         DeleteEntity(bs)
--                     end
--                     if DoesEntityExist(bt) then
--                         TriggerServerEvent("URK:deleteProp", NetworkGetNetworkIdFromEntity(bt))
--                         DeleteEntity(bt)
--                     end
--                     TriggerServerEvent("URK:removeVehicleStablisers", af)
--                     C[af] = nil
--                     tURK.notify("~g~Success~w~: Inflatable jack removed")
--                 end
--             else
--                 tURK.notify("~r~Error~w~: No inflatable jack found")
--             end
--         end
--     else
--         tURK.notify("~r~Error~w~: No vehicle found")
...
--     tURK.notify("~g~Success~w~: Use ARROW UP and ARROW DOWN to adjust the height. Press ENTER when done")
--     local bz = C[af][4]
--     C[af][5] = true
...
--                 bz = 0.8
--             end
--             TriggerServerEvent("URK:lfbHandlingLifting", bm, by, bz)
--         end
...
--             TriggerServerEvent("URK:lfbLiftingFreeze", bm)
--             C[af][5] = false
--             C[af][4] = bz
--             TriggerServerEvent("URK:updateJackTable", af, C[af], false)
--             tURK.notify("~g~Success~w~: You've stopped controlling the inflatable jack")
--             usingCarJack = false
--         end
--         Wait(0)
--     end
-- end
-- RegisterNetEvent("URK:lfbHandlingLifting",function(bm, by, bz)
...
-- end)
-- RegisterNetEvent("URK:lfbLiftingFreeze",function(bm)
...
--         if ad then
--             if ag then
--                 tURK.notify("~r~Error~w~: This vehicle already has chocks setup")
--             else
--                 local bu = GetEntityCoords(ae)
--                 ResetVehicleWheels(ae, true)
--                 tURK.loadModel(bB)
--                 TriggerServerEvent("URK:toggleChockWheels", af)
...
--                     Wait(0)
--                 end
--                 TriggerServerEvent("URK:createLFBPropLog", "Air Chocks", GetEntityCoords(bC, true))
--                 local bh = GetEntityHeading(ae)
...
--                 D[af] = {af, bK, bL, bM, bN}
--                 TriggerServerEvent("URK:updateChockTable", af, D[af], false)
--                 SetModelAsNoLongerNeeded(bB)
--                 TaskGoStraightToCoord(tURK.getPlayerPed(), bu.x, bu.y, bu.z, 30.0, 0.5, 0.0, 10.0)
--                 Wait(2000)
--                 FreezeEntityPosition(ae, true)
--                 tURK.notify("~g~Success~w~: Car chocks setup")
--             end
--         else
--             if ag then
--                 Wait(2000)
--                 local bC = tURK.getObjectId(D[af][2], "chock1")
--                 local bD = tURK.getObjectId(D[af][3], "chock2")
--                 local bE = tURK.getObjectId(D[af][4], "chock3")
--                 local bF = tURK.getObjectId(D[af][5], "chock4")
--                 Wait(1000)
...
--                     DeleteEntity(bF)
--                 end
--                 TriggerServerEvent("URK:updateChockTable", af, D[af], true)
--                 TriggerServerEvent("URK:removeVehicleStablisers", af)
--                 tURK.notify("~g~Success~w~: Car chocks removed")
--             else
--                 tURK.notify("~r~Error~w~: No car chocks found")
--             end
--         end
--     else
--         tURK.notify("~r~Error~w~: No vehicle found")
...
--     end
--     if bP then
--         tURK.notify("~g~Success~w~: Throw bag deployed")
--         spawnRope(at)
--     else
--         tURK.notify("~r~Error~w~: No player found")
--     end
--     bO = false
-- end
...
--     local a4 = tURK.getPlayerPed()
--     local t = tURK.getPlayerCoords()
--     TriggerServerEvent("URK:spawnThrowBag",t,tURK.getNetId(bR, "spawnRope(entity)"),tURK.getNetId(a4, "spawnRope(ped)"))
--     Wait(2000)
--     tURK.notify("~g~Success~w~: Rope is now winding")
-- end
-- local bS = 100
-- RegisterNetEvent("URK:spawnThrowBag",function(t, aq, bT)
--     local a4 = tURK.getPlayerPed()
--     local bv = tURK.getPlayerCoords()
--     local V = #(bv - t)
--     if V < 30.0 then
--         RopeLoadTextures()
--         local bU = tURK.getObjectId(aq, "spawnThrowBag 1")
--         local bV = tURK.getObjectId(bT, "spawnThrowBag 2")
