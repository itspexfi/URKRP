RegisterNetEvent("URK:announceRestart")
AddEventHandler("URK:announceRestart",function(a,b)
...
RegisterNetEvent("URK:smallAnnouncement",function(f,g,h,i)
    tURK.announceMpSmallMsg(f,g,h,i)
end)
function tURK.announceMpSmallMsg(f,g,h,i)
