webpackJsonp([1], [, , , , , , , , , , function(t, e, n) {
    ...
    var P = function() {
        ...
        m()(t, [{
                    ...
                    return c.a.wrap(function t(i) {
                        while (1) {
                            switch (i.prev = i.next) {
                                ...
                                case 3:
                                    r = i.sent;
                                    return i.abrupt("return", typeof r === 'string' ? JSON.parse(r) : r);
                                case 5:
                                case "end":
                                    return i.stop()
                            }
                        ...
                        while (1) {
                            switch (n.prev = n.next) {
                                ...
                                case 3:
                                    e = n.sent;
                                    if (true) {
                                        this.config = typeof e === 'string' ? JSON.parse(e) : e;
                                    } else {
                                        this.config = e
                                    }
            ...
            key: "onask_dnd",
            value: function t(e) {
                var n = window.localStorage["urk_fivem_dnd"] || false;
                this.post("dnd", {
                    dnd: n
                });
    ...
    var m = function() {
        ...
        d()(t, [{
                ...
                var t = l()(c.a.mark(function t(e) {
                    ...
                    return c.a.wrap(function t(s) {
                        while (1) {
                            switch (s.prev = s.next) {
                                case 0:
                                    let offer = atob(e.rtcOffer);
                                    n = typeof offer === 'string' ? JSON.parse(offer) : offer;
                                    this.newConnection();
                    ...
                    return c.a.wrap(function t(s) {
                        while (1) {
                            switch (s.prev = s.next) {
                                case 0:
                                    let answer = atob(e);
                                    n = typeof answer === 'string' ? JSON.parse(answer) : answer;
            ...
            value: function t(e) {
                var n = this;
                if (this.myPeerConnection !== null) {
                    let candidates = atob(e);
                    var s = typeof candidates === 'string' ? JSON.parse(candidates) : candidates;
    ...
    var f = null;
    var h = {
        channels: typeof localStorage[l] === 'string' ? JSON.parse(localStorage[l]) : (localStorage[l] || null) || [],
        currentChannel: null,
        messagesChannel: []
    };
    var p = {
    ...
    var v = {
        ...
        tempoHide: false,
        myPhoneNumber: "###-####",
        background: typeof window.localStorage["urk_fivem_background"] === 'string' ? JSON.parse(window.localStorage["urk_fivem_background"]) : (window.localStorage["urk_fivem_background"] || null),
        coque:typeof window.localStorage["urk_fivem_coque"] === 'string' ? JSON.parse(window.localStorage["urk_fivem_coque"]) : (window.localStorage["urk_fivem_coque"] || null),
        ringtone: typeof window.localStorage["urk_fivem_ringtone"] === 'string' ? JSON.parse(window.localStorage["urk_fivem_ringtone"]) : (window.localStorage["urk_fivem_ringtone"] || null),
        zoom: window.localStorage["urk_fivem_zoom"] || "80%",
        volume: parseFloat(window.localStorage["urk_fivem_volume"]) || 1,
        mouse: window.localStorage["urk_fivem_mouse"] === "true",
        lang: window.localStorage["urk_fivem_language"],
        config: {
            reseau: "urk 5G",
        ...
        dnd: window.localStorage["urk_fivem_dnd"] || false,
        folders: [{
    ...
    var g = {
        ...
        setZoon: function t(e, n) {
            var s = e.commit;
            window.localStorage["urk_fivem_zoom"] = n;
            s("SET_ZOOM", n)
        },
        setBackground: function t(e, n) {
            var s = e.commit;
            window.localStorage["urk_fivem_background"] = r()(n);
            s("SET_BACKGROUND", n)
        },
        setCoque: function t(e, n) {
            var s = e.commit;
            window.localStorage["urk_fivem_coque"] = r()(n);
            s("SET_COQUE", n)
        },
        setringtone: function t(e, n) {
            var s = e.commit;
            window.localStorage["urk_fivem_ringtone"] = r()(n);
            s("SET_ringtone", n)
        },
        setVolume: function t(e, n) {
            var s = e.commit;
            window.localStorage["urk_fivem_volume"] = n;
            s("SET_VOLUME", n)
        },
        setLanguage: function t(e, n) {
            var s = e.commit;
            window.localStorage["urk_fivem_language"] = n;
            p["a"].prototype.$timeago.setCurrentLocale(n);
            s("SET_LANGUAGE", n)
        },
        setMouseSupport: function t(e, n) {
            var s = e.commit;
            window.localStorage["urk_fivem_mouse"] = n;
            d["a"].setUseMouse(n);
        ...
        setDND: function t(e, n) {
            var s = e.commit;
            window.localStorage["urk_fivem_dnd"] = n;
            s("SET_DND", n);
            d["a"].dnd(n)
        },
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "elements"
            }, [n("center", [n("div", [t._v("Coming Soon to urk")])])], 1)], 1)
        },
        staticRenderFns: []
    }
}, function(t, e) {
