...
RegisterNetEvent("URKELS:changeStage", function(netId, stage)
...
RegisterNetEvent("URKELS:toggleSiren", function(netId, tone)
	if not VehicleConfigs then return end
...
RegisterNetEvent("URKELS:toggleBullhorn", function(netId, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("URKELS:patternChange", function(netId, patternIndex, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("URKELS:vehicleRemoved", function(netId)
...
RegisterNetEvent("URKELS:indicatorChange", function(netId, indicator, enabled)
